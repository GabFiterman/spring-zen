...
public class ContactServiceTest {
    ...
    public void testSaveContact() {
        ...
        CreateContactData data = new CreateContactData("John Contact", "john@example.com", Date.valueOf("2021-01-01"),
                professionalId);
    ...
    public void testGetAllContacts() {
        // Setup test data
        CreateContactData data1 = new CreateContactData("John Contact", "john@example.com", Date.valueOf("2021-10-24"),
                1L);
        CreateContactData data2 = new CreateContactData("Jane Contact", "jane@example.com", Date.valueOf("2021-06-31"),
                2L);
    ...
    public void testGetAllContactsWithFiltersAndFields() {
        // Setup test data
        CreateContactData data1 = new CreateContactData("John Contact", "john@example.com", Date.valueOf("2021-01-01"),
                1L);
        CreateContactData data2 = new CreateContactData("Jane Contact", "jane@example.com", Date.valueOf("2021-01-01"),
                2L);
        CreateContactData data3 = new CreateContactData("Bob Contact", "bob@example.com", Date.valueOf("2021-01-01"),
                1L);
